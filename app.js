...
const portfolioModes = {
  all: {
    ...
    title: "Selected work",
    intro: "Search across backend services, data infrastructure, observability showcases, and experiments.",
    hero: "Software engineer building reliable backend systems, data pipelines, and observable cloud infrastructure.",
...
const fallbackProjects = [
  {
    ...
    eyebrow: "Fast redirects + Grafana observability",
    description: "Production-style backend service instrumented with Prometheus and Grafana dashboards for latency, rate limiting, and redirect event analytics.",
    technologies: ["Python", "FastAPI", "Grafana", "Prometheus", "Docker", "Caching"],
    categories: ["backend", "fullstack"],
    repo_url: "https://github.com/DDFaller/click-shortener-grafana",
    featured: true,
  },
  {
    slug: "async-cv-inference",
    title: "Asynchronous Inference & Task Queue Service",
    eyebrow: "Queue-backed worker + retry flow",
    description: "FastAPI asynchronous background processing service with idempotent job submission, task state persistence, and worker retry workflows.",
    technologies: ["Python", "FastAPI", "Async Workers", "SQLite", "Docker"],
    categories: ["backend", "machine-learning"],
    repo_url: "https://github.com/DDFaller/async-cv-inference",
    featured: true,
  },
  {
    ...
    technologies: ["Python", "FastAPI", "REST API", "Search", "OpenAPI"],
    categories: ["backend", "fullstack"],
  ...
  },
  {
    ...
    technologies: ["YOLO", "Computer Vision", "Azure Kinect", "Python"],
    categories: ["computer-vision", "machine-learning"],
